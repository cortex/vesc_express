...
static lbm_value ext_wakeup_cause(lbm_value *args, lbm_uint argn) {
	(void) args;
	(void) argn;

	esp_sleep_wakeup_cause_t wuc = esp_sleep_get_wakeup_cause();

	return (lbm_enc_i((int32_t)wuc));
}

static void load_extensions(void) {
	register_symbols_hc();
	
	lbm_add_extension("wakeup-cause", ext_wakeup_cause);
